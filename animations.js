...
const SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbyp6qvKGdJ5eJnwk4cuBZcXBp9atNseJrutUEaZSVdDzSCmbglwqtcLUUtA2FRyY_UvoA/exec";
...
function initAdminPanel() {
  ...
  if (toggleFormationsTableBtn && formationsTableContainer) {
    toggleFormationsTableBtn.addEventListener('click', () => {
      ...
      if (isTableVisible) {
        // Afficher le tableau
        formationsTableContainer.style.display = '';
        formationsTableContainer.style.maxHeight = '2000px';
        ...
        formationsTableContainer.style.visibility = '';
...
// Ajouter l'appel à la fonction au chargement de la page
document.addEventListener("DOMContentLoaded", () => {
  // Appel existant
  const notify = initNotifications();
  initNavigation();
